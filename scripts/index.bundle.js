...
var fbHandler = function () {
  ...
  return {
    ...
    share: function share(message) {
      fbHandler.login(function () {
        fbHandler.doShare(message);
      });
    },
    doShare: function doShare(message) {
      FB.ui({
        method: 'feed',
...
var windowSizeHandler = function () {
  return {
    windowSizeListener: function windowSizeListener(e) {
      if ((0, _jquery2.default)(window).height() > 400) {
        (0, _jquery2.default)('#infoButton').hide();
      } else {
        (0, _jquery2.default)('#infoButton').show();
      }
    },
    startListener: function startListener() {
      (0, _jquery2.default)(window).bind("resize", windowSizeHandler.windowSizeListener);
...
var dataFetcher = function () {
  ...
  return {
    fetchData: function fetchData() {
      _jquery2.default.getJSON(DATA_URL, function (data) {
    ...
    updateData: function updateData(data) {
      ...
      if (totalData > 1000000) {
        (0, _jquery2.default)("#totalMB").text(totalData / 10000 + ' TB');
      } else {
        (0, _jquery2.default)("#totalMB").text(totalData / 1000 + ' GB');
      }
      (0, _jquery2.default)("#totalUsers").text('av ' + totalUsers + ' användare');
      (0, _jquery2.default)("#wattHour").text((totalData * 5.9 / 1000).toFixed(2) + ' kWh');
      (0, _jquery2.default)("#wattIphone").text((totalData * 5.9 / 9.5).toFixed(0));
      (0, _jquery2.default)("#wattCar").text((totalData * 5.9 / (300 * 1.6)).toFixed(1));
    },
...
var musicHandler = function () {
  ...
  return {
    play: function play() {
      if (!muted) {
        (0, _jquery2.default)('#sound' + musicHandler.sound)[0].play();
      };
    },
    pause: function pause() {
      (0, _jquery2.default)('#sound' + musicHandler.sound)[0].pause();
    },
    muteClicked: function muteClicked() {
      muted = !muted;
      if (!muted) {
        musicHandler.unmute();
      } else {
    ...
    mute: function mute() {
      (0, _jquery2.default)("#muteButton").text("UNMUTE");
      musicHandler.pause();
    },
    unmute: function unmute() {
      (0, _jquery2.default)("#muteButton").text("MUTE");
      musicHandler.play();
    },
    setSound: function setSound(sound) {
...
var progressBarController = function () {
  return {
    init: function init() {
      (0, _jquery2.default)("#progressBar").width('0%').text('0%');
      (0, _jquery2.default)(".progress").show("veryslow");
      progressBarController.lastMeasurement = new Date().getTime();
    },
    finished: function finished() {
      (0, _jquery2.default)(".progress").hide("veryslow");
      (0, _jquery2.default)("#progressStatusField").text("Det är ändå rätt mycket när allt kommer omkring!");
    },
    update: function update(downloadedMB, targetMB, mbPerSecond) {
      (0, _jquery2.default)("#progressStatusField").text(downloadedMB.toFixed(2) + ' MB av ' + targetMB + ' MB Nerladdat (' + (mbPerSecond + ' Mbit/s)' || ""));
      (0, _jquery2.default)("#progressBar").width(downloadedMB / targetMB * 100 + '%').text((downloadedMB / targetMB * 100).toFixed(2) + '%');
    },
    cancel: function cancel() {
      (0, _jquery2.default)("#progressStatusField").text('');
      (0, _jquery2.default)("#progressBar").width('0%').text('0%');
    }
  };
}();
var vaskController = function () {
  ...
  return {
    init: function init() {
      fbHandler.init();
      (0, _jquery2.default)('#myCarousel').carousel({
        interval: 0
      });
      (0, _jquery2.default)('.progress .bar').first().css('width', '100%');
      (0, _jquery2.default)(".preload").fadeOut(500, function () {
        (0, _jquery2.default)(".content").fadeIn(500);
      });
      //windowSizeHandler.startListener();
      (0, _jquery2.default)('.marketing').hide();
      (0, _jquery2.default)("#shareButton").hide();
      (0, _jquery2.default)('#moreInfoButton').hide();
    },
    start: function start() {
      dataFetcher.fetchData();
      musicHandler.play();
      ...
      (0, _jquery2.default)('#moreInfoButton').hide();
      (0, _jquery2.default)('#shareButton').hide();
      (0, _jquery2.default)("#muteButton").show();
      (0, _jquery2.default)("#vaskStyle").text(vaskController.style);
      (0, _jquery2.default)("#avbrytVask").text("Avbryt");
      if (vaskController.numOfMB < 50) {
        //prova den stora ett tag
    ...
    finished: function finished() {
      dataFetcher.start();
      (0, _jquery2.default)('#moreInfoButton').show();
      (0, _jquery2.default)('#shareButton').show("fast");
      progressBarController.finished();
      resultHandler.uploadResult(vaskController.numOfMB);
      musicHandler.pause();
      (0, _jquery2.default)('.marketing').show("slow");
      (0, _jquery2.default)("#vaskStyle").text(vaskController.numOfMB + "MB = " + vaskController.numOfMB * 5.9 + "Wh!");
      (0, _jquery2.default)("#muteButton").hide();
      (0, _jquery2.default)("#avbrytVask").attr('data-slide', '').attr('data-slide', 'prev').text("En gång till!");
    },
    cancel: function cancel() {
      ...
      this.procent = 100;
      (0, _jquery2.default)('.marketing').show("slow");
      (0, _jquery2.default)("#progressBar").width(0 + '%');
    },
    setSize: function setSize(size) {
      this.numOfMB = size;
    },
    setStyleTitle: function setStyleTitle(text) {
      this.style = text;
    }
  };
}();
var resultHandler = function () {
  return {
    uploadResult: function uploadResult(numOfMB) {
...
//BUTTON LISTENERS//////////////////////
(0, _jquery2.default)('#infoButton').click(function () {
  (0, _jquery2.default)('html, body').animate({
    scrollTop: (0, _jquery2.default)("#info").offset().top
  }, 1000);
});
(0, _jquery2.default)("#faceButton").click(function () {
  window.open("https://www.facebook.com/Vasktrafik", '_blank');
});
(0, _jquery2.default)("#twitterButton").click(function () {
...
(0, _jquery2.default)("#moreInfoButton").click(function () {
  (0, _jquery2.default)('html, body').animate({
    scrollTop: (0, _jquery2.default)("#info").offset().top
  }, 1000);
});
(0, _jquery2.default)("#shareButton").click(function () {
...
var imageDownloader = function () {
  ...
  return {
    startLoop: function startLoop(url, imgSize, targetMB) {
    ...
    loop: function loop() {
      if (imageDownloader.run) {
        ...
        var sound = _jquery2.default.ajax({
...
require('./Modules/old_app.js');

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

},{"./Modules/old_app.js":2,"./libs/bootstrap.min.js":4,"jquery":1}],4:[function(require,module,exports){
'use strict';
